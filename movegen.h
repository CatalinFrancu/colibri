 ...
 * When forward = false, this function returns all backward moves, under some assumptions:
 ...
 *
 * (1) So if the en passant field is a3, this routine doesn't realize that the only legal backward move is e4.
 * (2) For example, with White Na1 and Black Ke1, this function will produce the backward moves Na3 and Nc2. In reality, Nc2 is illegal because,
